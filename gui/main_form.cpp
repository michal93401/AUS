...
void main(array<String^>^)
{
	...
	//tests.emplace_back(new tests::ArrayListTestOverall());
	//tests.emplace_back(new tests::ArrayListTestInsert());
	...
	tests.emplace_back(new tests::MatrixScenarTest());
	//tests.emplace_back(new tests::IncoherentMatrixTestOverall);
	//tests.emplace_back(new tests::CoherentMatrixTestOverall);
...
// MainForm:
	...
	System::Void gui::MainForm::LogDuration(size_t size, tests::Microseconds duration, const std::string& message)
	{
